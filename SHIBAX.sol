...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //SHIBA
...
contract SHIBAX is ERC20, Ownable {
    ...
    address private constant ETH = address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //SHIBA

    uint256 public swapTokensAtAmount = 100 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0xF5Fa091E9aCEB522f1c48a3271cDBff2140B7275)); //marketing wallet
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("SHIBAX_Dividend_Tracker", "SHIBAX_Dividend_Tracker")
    {
        claimWait = 3600;
